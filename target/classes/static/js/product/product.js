...
window.updateLocalProduct = async function (index, field, element) {
    ...
    console.log("QWERTY MAP VALUES");
    console.log("QWERTY MAP VALUES");
    console.log("QWERTY MAP VALUES");
    console.log(Object.keys(changedProductsMap).length); // количество изменённых
    console.log(Object.values(changedProductsMap));     // список изменённых
...
async function saveProducts() {
    ...
    console.log("QQWWEWRR");
    console.log(chengeProducts);
